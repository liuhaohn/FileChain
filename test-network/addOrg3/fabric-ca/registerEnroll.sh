...
#  rm -rf $FABRIC_CA_CLIENT_HOME/msp
  ...
  echo
  set -x
	fabric-ca-client register --csr.names O=org3.example.com --caname ca-org3 --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client register --csr.names O=org3.example.com --caname ca-org3 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
  fabric-ca-client register --csr.names O=org3.example.com --caname ca-org3 --id.name org3admin --id.secret org3adminpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
  # 生成的visitor只用来登录node，所以id.type是visitor以保证其无权以org3的身份访问channel，visitor身份只能被node登录时识别到
  fabric-ca-client register --csr.names O=org3.example.com --caname ca-org3 --id.name org3visitor --id.secret org3visitorpw --id.type visitor --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll --csr.names O=org3.example.com -u https://peer0:peer0pw@localhost:11054 --caname ca-org3 -M ${PWD}/../organizations/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/msp --csr.hosts peer0.org3.example.com --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll --csr.names O=org3.example.com -u https://user1:user1pw@localhost:11054 --caname ca-org3 -M ${PWD}/../organizations/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  echo
  set -x
	fabric-ca-client enroll --csr.names O=org3.example.com -u https://org3admin:org3adminpw@localhost:11054 --caname ca-org3 -M ${PWD}/../organizations/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x
  ...
  mkdir -p ../organizations/peerOrganizations/org3.example.com/users/Visitor@org3.example.com

  echo
  echo "## Generate the visitor msp"
  echo
  set -x
	fabric-ca-client enroll --csr.names O=org3.example.com -u https://org3visitor:org3visitorpw@localhost:11054 --caname ca-org3 -M ${PWD}/../organizations/peerOrganizations/org3.example.com/users/Visitor@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  set +x

  cp ${PWD}/../organizations/peerOrganizations/org3.example.com/msp/config.yaml ${PWD}/../organizations/peerOrganizations/org3.example.com/users/Visitor@org3.example.com/msp/config.yaml
